...
function vpb_submit_captcha()
{
	...
	{	
		...
		$.ajax({
			...
			beforeSend: function() 
			{
				$(".fakeContent #captchaResponse,.containerHorizontal #captchaResponse").html('<div style="padding-left:100px;margin-bottom:30px;"><font style="font-family:Verdana, Geneva, sans-serif; font-size:12px; color:black;">Prosím čakajte</font> <img src="load.gif" align="absmiddle" /></div>');
			},
