			...
			<tr>
				<td>
					<div style="float: left">
						 ...
						 <input type="text" value="'.$pole[2].'" size="3" class="input_t" id="snimac_id_'.$pole[0].'" />&nbsp;
						 <input type="text" value="'.$pole[3].'" size="5" class="input_t" id="snimac_cislof_'.$pole[0].'" />&nbsp;
						 <input type="text" value="'.$pole[4].'" size="3" class="input_t" id="snimac_adresa_'.$pole[0].'" />&nbsp;
						 <input type="text" value="'.$pole[5].'" size="20" class="input_t" id="snimac_popis_'.$pole[0].'" />&nbsp;
						 <input type="text" value="'.$pole[6].'" size="20" class="input_t" id="snimac_typ_'.$pole[0].'" />
					 </div>
		...
		if($table == "sireny")
			...
			<tr>
				<td>
					 ...
					 <div style="float: left; width: 210px"><input type="checkbox" '.$checked_zaloha.' />'.$checked_zaloha_val.'</div>
					 <div style="float: left; width: 120px"><input type="checkbox" '.$checked_func.' />'.$checked_func_val.'</div>
...
function prevedQuery_snimac_update(input){
    ...
    query =  query + "&id_item=" + input + "&id=" + id + "&cislof=" + cislof+ "&adresa=" + adresa + "&popis=" + popis+ "&typ=" + typ+ "&funkcnost=" + funkcnost + "&poloha=" + poloha;
    query =  query + "&uique=" + new Date().getTime(); 
	...
	<tr>
		...
		<div style="background-color: #AFE1FF;padding: 10px;border: 1px solid #5BB9F3;">
			...
			<table border="0" cellpadding="0" cellspacing="3">
				...
				<tr>
					<td> <input name="idSnimac" id="idSnimac" type="text" value="1" size="3"  class="button_print" /></td>
					<td> <input name="cisloFormu" id="cisloFormu" type="text" value="" size="4"  class="button_print" /></td>
					<td> <input name="adresaSnimac" id="adresaSnimac" type="text" value="" size="3" class="button_print" /></td>
					<td> <input name="popisSnimac" id="popisSnimac" type="text" value="" size="20" class="button_print" /></td>
					<td> <input name="typSnimac" id="typSnimac" type="text" value="" size="20" class="button_print" /></td>
			...
			<table border="0" cellpadding="0" cellspacing="3">
				...
				<tr>
					<td> <input name="idSirena" id="idSirena" type="text" value="1" size="3" class="button_print" /></td>
					<td> <input name="cisloSirena" id="cisloSirena" type="text" value="" size="15" class="button_print" /></td>
					<td> <input name="umiestnenieSirena" id="umiestnenieSirena" type="text" value="" size="15" class="button_print" /></td>
					<td> <input name="typSirena" id="typSirena" type="text" value="" size="10" class="button_print" /></td>
