			...
			if( isset($tab_contents_array[$currenttab]) )
			  {
				...
				if(!strpos($contentarray[$i][1],"page_url") !== false){
				?>
				<div class="pageoverflow">
					<div class="pagetext"><?php echo ((strpos($contentarray[$i][0],"*Text menu") !== false) ? "<label for='in_menutext'>*Názov En:</label>" : $contentarray[$i][0]) ?></div>
					<div class="pageinput">
