		...
		<div id="oe_container" class="sidebar-on">
			...
			<header role="banner" class="cf header">
				...
				<div class="header-top cf">
					<!-- logo -->
					<div class="cms-logo">
						<a href="#" rel="external"><img style="margin-top:11px;" src="{$config.admin_url}/themes/OneEleven/images/cmsms_login_logo.png" width="180" height="36" alt="CMS Made Simple" title="CMS gooseberry" /></a>
					</div>
					<!-- title -->
